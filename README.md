...
```
1. **Создание заявки:** Клиент вводит тему и описание проблемы в личном кабинете и отправляет заявку.
...
4. **Сохранение и отображение:** Заявка сохраняется в СУБД с присвоенным приоритетом и отображается в консоли оператора с соответствующей цветовой маркировкой.
...
* **Основной сценарий:**
  <ol type="1">
    <li>Оператор видит список входящих заявок, отсортированных по приоритету (от Ннивысшего к низшему).</li>
